 ...
 * @author Jeff Gilfelt
 */
public class BadgeCartIcon extends TextView {
    ...
    public BadgeCartIcon(Context context) {
        this(context, (AttributeSet) null, android.R.attr.textViewStyle);
    }

    public BadgeCartIcon(Context context, AttributeSet attrs) {
     ...
     */
    public BadgeCartIcon(Context context, View target) {
     ...
     */
    public BadgeCartIcon(Context context, TabWidget target, int index) {
        this(context, null, android.R.attr.textViewStyle, target, index);
    }

    public BadgeCartIcon(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, null, 0);
    }

    public BadgeCartIcon(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
